            ...
            >
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center">
                  <a href="/cliente" className="btn text-white" style={{ backgroundColor: "rgb(69,32,23)" }}>
                    Acessar
                  </a>
                </div>
              </div>
          ...
          <div className="col-md-3 col-sm-12 mb-4">
            ...
            >
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center">
                  <a href="/pet" className="btn text-white" style={{ backgroundColor: "rgb(69,32,23)" }}>
                    Acessar
                  </a>
                </div>
              </div>
          ...
          <div className="col-md-3 col-sm-12 mb-4">
            ...
            >
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center">
                  <a href="/produto" className="btn text-white" style={{ backgroundColor: "rgb(69,32,23)" }}>
                    Acessar
                  </a>
                </div>
              </div>
          ...
          <div className="col-md-3 col-sm-12 mb-4">
            ...
            >
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center">
                  <a href="/servico" className="btn text-white" style={{ backgroundColor: "rgb(69,32,23)" }}>
                    Acessar
                  </a>
                </div>
              </div>
